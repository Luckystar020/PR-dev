<template>
  <div>
    <el-row :gutter="20">
      <h1 id="header"><b>New / Purchase Request</b></h1>
    </el-row>
      ...
      <el-row :gutter="20">
          <el-form-item>
            <el-col :span="24" :md="12">
              ...
              <el-select class="form_input"  placeholder="please select branch">
        ...
        <el-row :gutter="20">
            <el-form-item>
              <el-col :span="24" :md="12">
                ...
                <el-select class="form_input"  placeholder="please select your request">
                  <el-option label="Zone one" value="shanghai"></el-option>
                  <el-option label="Zone two" value="beijing"></el-option>
              </el-select>
            </el-col>
          ...
          <el-row :gutter="20">
              <el-form-item>
                <el-col :span="24" :md="24">
                  ...
                  <el-select class="form_input"  placeholder="please select projectname">
                    <el-option label="Zone one" value="shanghai"></el-option>
                    <el-option label="Zone two" value="beijing"></el-option>
                </el-select>
              </el-col>
